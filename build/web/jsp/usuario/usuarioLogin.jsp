...
<mtw:form klass="form-horizontal" action="UsuarioLogin.mtw" method="post">
    <html>
        <head>
        ...
        <body>
            ...
            <div id="form-horizontal" class="span10 offset2" >
                ...
                <div id="Login" style="margin-left: 60px;">
                        <br>
                        <p></p><h4 align="center" style="color:#FFF; margin-top:7px;"> Acesso Restrito</h4>
                        <div>  
                            <div align="center" >
                                <table class="tabela" border="0" cellpadding="0" cellspacing="0">                                             
                                    <tr >
                                        ...
                                        <th>Usuário</th>
                                        <td><mtw:input type="text" klass="input-medium" name="login" id="login" /></td>                        
                                    </tr>
                                    <tr>
                                        <th>Senha</th>
                                        <td><mtw:input type="password" klass="input-medium" name="senha" id="senha"/></td>
                                    </tr>
                                    <tr>
                                        <td></td>
