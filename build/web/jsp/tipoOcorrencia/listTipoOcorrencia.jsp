...
<mtw:form klass="form-horizontal" action="TipoOcorrenciaRead.mtw" method="post">
        ...
        <head>
            ...
            <script language="javascript" type="text/javascript">
                function validaForm()
                {
                    ...
                    if (document.getElementById('nomeTipoOcorrencia').value == '')
                    {
                        alert('O campo Novo Tipo de Ocorrência é obrigatório.');
                        document.getElementById('nomeTipoOcorrencia').focus();
                        return false;
                    }
                } 
                //------------------------------------------------------------------------------------------------------
            ...
            <div id="form-horizontal" class="container " >
                ...
                <div id="form-horizontal" class="span10 offset1" align="justify">  
                    ...
                    <div class="input-append">
                        <legend>Consulta Tipos de Ocorrências</legend>
                    ...
                    <div class="table table-bordered table-condensed table-hover" align="left" style="margin-top: 20px;" >
                        <display:table cellpadding="20" id="row" pagesize="10" requestURI="" name="listaTipoOcorrencia" class="commonDisplayTag">
                            <display:column property="nome" title="Nome" sortable="true" class="ColunaNome"/>
                            <display:column value="<a href='./TipoOcorrenciaShowForm.mtw?id=${row.id}'><img src='../../imagem/edit.png' alt='editar' /></a>" title="Editar" class="ColunaBotao"/>
                            <display:column value="<a href='./TipoOcorrenciaDelete.mtw?id=${row.id}'><img src='../../imagem/delete.png' /></a>" title="Excluir" class="deleteLink"/>
                        </display:table>
                    </div>
                </div><br><br><br>
                            </div>  
                        ...
                        <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-header">
                                ...
                                <h3 id="myModalLabel">Inserir Tipo de Ocorrência</h3>
                            </div>
                            <div class="modal-body">
                                <mtw:form action="TipoOcorrenciaCreate.mtw" method="post"><br>
                                        Novo Tipo de Ocorrência: <mtw:input id="nomeTipoOcorrencia" name="nome" type="text"/><br>
                                            <h5 align="center">&nbsp;</h5>
