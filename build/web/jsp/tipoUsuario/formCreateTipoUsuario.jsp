...
<html>
    ...
    <body>
        ...
        <div id="Fundo_topo_geral" align="center" style="margin-top:-8px;margin-left: -8px; margin-right: 0px;">    
            ...
            <div id="Fundo_geral" style="margin-top: 6px; margin-left:0px;">
                <div id="meio" >
                    <div id="conteudo_meio">                        
                        <h4 align="center">&nbsp;</h4>
                        <h3 align="left">Cadastro de tipo de Usuário</h3>
                        <div id="box_form" >
                            <mtw:form action="TipoUsuarioCreate.mtw" name="cadastro"><br>
                                Novo Tipo Usuario: <mtw:input name="nome" type="text"/><br>
                                <h5 align="center">&nbsp;</h5>
                                <p>
