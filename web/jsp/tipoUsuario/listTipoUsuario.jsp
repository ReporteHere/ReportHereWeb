...
<mtw:form klass="form-horizontal" action="TipoUsuarioRead.mtw" method="post">
        ...
        <head>
            ...
            <script language="javascript" type="text/javascript">
                function validaForm()
                {
                    ...
                    if (document.getElementById('nomeDepartamento').value == '')
                    {
                        alert('O campo Nome é obrigatório.');
                        document.getElementById('nomeDepartamento').focus();
                        return false;
                    }
                }
                //------------------------------------------------------------------------------------------------------
            ...
            <div id="form-horizontal" class="container " >
                ...
                <div id="form-horizontal" class="span10 offset1" align="justify">  
                    ...
                    <div class="input-append">
                            <legend>Consulta Departamentos</legend>
                    ...
                    <div class="table table-bordered table-condensed table-hover" align="left" style="margin-top: 20px;">
                        <display:table id="row" pagesize="10" requestURI="" name="listTipoUsuario" class="commonDisplayTag">
                            <display:column property="nome" title="Nome" sortable="true" class="ColunaNome"/>
                            <display:column value="<a href='./TipoUsuarioShowForm.mtw?id=${row.id}'><img src='../../imagem/edit.png' alt='editar' /></a>" title="Editar" class="ColunaBotao"/>
                            <display:column value="<a href='./TipoUsuarioDelete.mtw?id=${row.id}'><img src='../../imagem/delete.png' /></a>" title="Excluir" class="deleteLink"/>
                        </display:table>
                        ...
                        <div id="myModal" class="modal hide fade" tabindex="-10" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 id="myModalLabel">Inserir Departamento</h3>
                            </div>
                            <div class="modal-body">
                                <mtw:form action="TipoUsuarioCreate.mtw" method="post"><br>
                                        Novo Departamento: <mtw:input id="nomeDepartamento" name="nome" type="text"/><br>
                                            <h5 align="center">&nbsp;</h5>
                                            <button name="salvar" class="btn btn-success" value="salvar" onclick="return validaForm()">Salvar</button>
                                            <a href="TipoUsuarioRead.mtw" name="cancelar" class="btn btn-primary"  value="cancelar">Cancelar</a>
                                        </mtw:form>
                                        </div>
